...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${APP_PATH}/static/images/run.jpg" alt="First">
        </div>
        <div class="item">
            <img src="${APP_PATH}/static/images/flower.jpg" alt="Second">
        </div>
        <div class="item">
            <img src="${APP_PATH}/static/images/snow_evening.jpg" alt="Third">
        </div>
    </div>
